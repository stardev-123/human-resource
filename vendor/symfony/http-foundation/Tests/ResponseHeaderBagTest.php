...
class ResponseHeaderBagTest extends TestCase
{
    ...
    public function testToStringIncludesCookieHeaders()
    {
        ...
        $this->assertSetCookieHeader('foo=deleted; expires='.gmdate('D, Y-m-d H:i:s T', time() - 31536001).'; path=/; httponly', $bag);
    }
    ...
    public function testClearCookieSecureNotHttpOnly()
    {
        ...
        $this->assertSetCookieHeader('foo=deleted; expires='.gmdate('D, Y-m-d H:i:s T', time() - 31536001).'; path=/; secure', $bag);
    }
