...
class CookieTest extends TestCase
{
    ...
    public function testToString()
    {
        ...
        $this->assertEquals('foo=deleted; expires='.gmdate('D, Y-m-d H:i:s T', time() - 31536001).'; path=/admin/; domain=.myfoodomain.com; httponly', (string) $cookie, '->__toString() returns string representation of a cleared cookie if value is NULL');
