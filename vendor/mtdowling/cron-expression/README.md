...
$cron->isDue();
echo $cron->getNextRunDate()->format('d-m-Y H:i:s');
echo $cron->getPreviousRunDate()->format('d-m-Y H:i:s');
...
$cron = Cron\CronExpression::factory('@daily');
echo $cron->getNextRunDate(null, 2)->format('d-m-Y H:i:s');

// Calculate a run date relative to a specific time
$cron = Cron\CronExpression::factory('@monthly');
echo $cron->getNextRunDate('2010-01-12 00:00:00')->format('d-m-Y H:i:s');
```
